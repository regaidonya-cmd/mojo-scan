...
export default async function AdminPage({
  ...
  if (searchParams.password !== process.env.ADMIN_PASSWORD) {
    return (
      <div style={{ minHeight: '100vh', background: '#F7F6FC', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'sans-serif' }}>
        <form method="GET" style={{ background: '#fff', padding: 32, borderRadius: 16, border: '1px solid #EDEAF5', width: 320 }}>
  ...
  return <AdminView diagnostics={diagnostics ?? []} password={searchParams.password!} />
}
