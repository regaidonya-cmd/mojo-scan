...
import { ProspectsTable } from '@/components/sales/ProspectsTable'
...
export default async function ProspectsPage() {
  ...
  // Réutilise la même couche de données que MA JOURNEE — pas de requêtes dupliquées.
  const all = await fetchMaJourneeData()

  return (
    <div style={{ minHeight: '100vh', background: '#FAFAF8' }}>
      <SalesNav active="prospects" />
      <ProspectsTable all={all} />
    </div>
  )
}
